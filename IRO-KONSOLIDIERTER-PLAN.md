...
**Stand:** 23. September 2026 · **Fassung:** 1.33 – Automatische Prüfung verifizierter Verhaltenserwartungen
...
**Aktuelle Korrektur in Analyse 0.5.3, Fassung 1.32:** Die kombinierte Fehlfreigabe entstand durch den vorzeitigen Abbruch der Verjüngungsprüfung bei nur zwei erkannten Feldern. Nun werden auch zwei Felder geprüft, sofern beide Konturen gleichgerichtete Verjüngung unabhängig belegen; die übrigen Versuchsschwellen bleiben unverändert. Rechteckkontrollen und einseitige Konturverjüngung lösen diese Sperre nicht aus. 28 gezielte Geometrieprüfungen und alle zehn Erwartungen des unveränderten IroGen-Plans bestanden. Der [Nutzer-Gegenlauf mit Analyse 0.5.3](iro-gen/testplans/iro-testbericht-20260923-123744.md) bestätigt alle zehn Erwartungen ebenfalls: sechs vollständig messbare Bilder und vier korrekte Sperren. Abschließende Gesamttests und Grenzen im [Geometrienachweis](docs/geometrie-schutzpruefung.md). Die konkrete Lücke ist technisch behoben, Nutzerabnahme offen; keine allgemeine Perspektiv- oder Gerätefreigabe.
**Erwartungsprüfung, Fassung 1.33:** IroGen 1.5.0 lädt Testpläne v2 mit geprüften bildbezogenen Freigaben, freigegebenen Feldanzahlen und fachlichen Haupt-Hinweisen. Analyse 0.5.4 liefert dafür stabile Haupt-Hinweiscodes ohne Änderung der Messentscheidung. Erst der externe Serienläufer vergleicht nach der Pixelanalyse; Erwartung und Prüfbefund werden in Analyselauf v2 gespeichert. Dialog und Export trennen erfüllt, nicht erfüllt, nicht bewertet und Prüffehler von nominalen Farbdiagnosen. Alte Pläne bleiben nutzbar, alte Läufe werden nicht rückwirkend bewertet. Diese erste Stufe prüft noch keine Farbgenauigkeit, Feldidentitäten oder sämtliche Einzelhinweise. [Verträge, Grenzen, Prüfungen und Nutzerablauf](docs/verhaltenserwartungen.md). Nutzerabnahme offen.
**Vorrangig offen:** belastbare starke-Perspektive-Sperre, Unterbelichtungsprüfung ohne Endpunktanschlag, vergleichbare Beleuchtung beider Messpartner, verbleibende Vollständigkeits-/Unschärfe-/Reflexerkennung sowie weitergehende Feld-/Farbwerterwartungen und unabhängige Abnahmedaten. Die erste bildbezogene Freigabe-/Hinweisprüfung ist in Fassung 1.33 umgesetzt. Keine universellen Schwellen aus Generatorstufen ableiten. Warnung versus Ablehnung bei Schatten bleibt gemäß Nutzerprotokoll konkret festzulegen. Kein Erkennungsbild-Aufhellen, Nachschärfen oder neues Farbkorrekturmodell vor dem Schließen beziehungsweise ausdrücklich abgenommenen Abgrenzen dieser Lücken. Die noch fehlende Kamera ist eine spätere Entwicklungsphase, kein Anlass, die technische Abnahme zu überspringen.
...
| 23. September 2026 | 1.32 (ergänzender Prüfnachweis, Anforderungen unverändert) | Nutzer-Gegenlauf bestätigt 10/10 Erwartungen der begrenzten Konturkorrektur unter Analyse 0.5.3. | Reproduzierbare Fehlerbehebung auch über den vom Nutzer ausgeführten IroGen-Ablauf belegen; keine Nutzerabnahme aus bloßer Berichtsvorlage ableiten. | [Übermittelter Testbericht](iro-gen/testplans/iro-testbericht-20260923-123744.md). |
| 23. September 2026 | 1.32 → 1.33 | Erste automatische Verhaltenserwartungsprüfung: Testplan v2, Analyselauf v2, getrennte Soll-Ist-Anzeige und vollständiger Export; Altformate bleiben lesbar. | Verifizierte Erwartungen nach der Analyse automatisch vergleichen, ohne sie als Analysehilfe oder nominale Farbwerte als Genauigkeitsbeleg zu verwenden. | Ausdrücklicher Nutzerauftrag zur Umsetzung der vorgeschlagenen ersten Stufe; [Verträge und Prüfungen](docs/verhaltenserwartungen.md). |
